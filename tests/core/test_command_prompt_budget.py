...
COMMAND_BASELINES = {
    ...
    "derive-equation": (418, 18507, 1),
    "digest-knowledge": (313, 12_468, 1),
    "dimensional-analysis": (133, 5750, 1),
    ...
    "route": (185, 7_305, 1),
    "sensitivity-analysis": (147, 6438, 1),
    "set-profile": (115, 3612, 1),
    "set-tier-models": (215, 8_447, 1),
    "settings": (384, 20248, 1),
...
WORKFLOW_BASELINES = {
    ...
    "derive-equation": (344, 15737, 2),
    "digest-knowledge": (226, 9_302, 0),
    "dimensional-analysis": (90, 4630, 1),
    ...
    "route": (130, 5_142, 0),
    "sensitivity-analysis": (101, 5207, 1),
    "set-profile": (85, 2775, 0),
    "set-tier-models": (167, 6_901, 0),
    "settings": (350, 19072, 1),
